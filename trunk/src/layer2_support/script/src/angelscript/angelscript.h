...
class asIScriptEngine
{
  public:
    ...
    virtual int                 RegisterObjectMethod( const char*   obj,
                                                      const char*   declaration,
                                                      asUPtr        funcPointer,
                                                      int           callConv ) = 0;
    virtual int                 RegisterObjectBehaviour( const char*   datatype,
                                                         asDWORD       behaviour,
                                                         const char*   declaration,
                                                         asUPtr        funcPointer,
                                                         int           callConv ) = 0;
    ...
    virtual int                 RegisterGlobalFunction( const char* declaration, asUPtr funcPointer, int callConv ) = 0;

    virtual int                 RegisterStringFactory( const char* datatype, asUPtr factoryFunc, asDWORD callConv ) = 0;

    // Script modules
    virtual int                 AddScriptSection( const char*   module,
                                                  const char*   name,
                                                  const char*   code,
                                                  int           codeLength,
                                                  int           lineOffset = 0 ) = 0;
    ...
    virtual const char*         GetModuleNameFromIndex( int index ) = 0;
    ...
    virtual int                 GetImportedFunctionDeclaration( const char*   module,
                                                                int           importIndex,
                                                                char*         buffer,
                                                                int           bufferSize ) = 0;
    virtual const char*         GetImportedFunctionSourceModule( const char* module, int importIndex ) = 0;
    ...
    virtual int                 ExecuteString( const char*       module,
                                               const char*       script,
...
// Return codes
const long    asSUCCESS = 0;
const long    asERROR = -1;
const long    asCONTEXT_ACTIVE = -2;
const long    asCONTEXT_NOT_FINISHED = -3;
const long    asCONTEXT_NOT_PREPARED = -4;
const long    asINVALID_ARG = -5;
const long    asNO_FUNCTION = -6;
const long    asNOT_SUPPORTED = -7;
const long    asINVALID_NAME = -8;
const long    asNAME_TAKEN = -9;
const long    asINVALID_DECLARATION = -10;
const long    asINVALID_OBJECT = -11;
const long    asINVALID_TYPE = -12;
const long    asALREADY_REGISTERED = -13;
const long    asMULTIPLE_FUNCTIONS = -14;
const long    asNO_MODULE = -15;
const long    asNO_GLOBAL_VAR = -16;
const long    asINVALID_CONFIGURATION = -17;
const long    asINVALID_INTERFACE = -18;
const long    asCANT_BIND_ALL_FUNCTIONS = -19;

// Context states
const asDWORD asEXECUTION_FINISHED = 0;
const asDWORD asEXECUTION_SUSPENDED = 1;
const asDWORD asEXECUTION_ABORTED = 2;
const asDWORD asEXECUTION_EXCEPTION = 3;
const asDWORD asEXECUTION_PREPARED = 4;
const asDWORD asEXECUTION_UNINITIALIZED = 5;
const asDWORD asEXECUTION_ACTIVE = 6;
